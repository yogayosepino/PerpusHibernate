...
public abstract class _BaseRootDAO {
	...
	public static void initialize () {
		com.ams.model.dao._RootDAO.initialize(
			(String) null);
	}
	...
	public static void initialize (String configFileName) {
		com.ams.model.dao._RootDAO.initialize(
			configFileName,
			com.ams.model.dao._RootDAO.getNewConfiguration(
				null));
	}
	...
	public static void initialize (String configFileName, Configuration configuration) {
		if (null == configFileName && null != sessionFactory) return;
			...
			if (null == configFileName) {
				...
				com.ams.model.dao._RootDAO.setSessionFactory(
	 ...
	 * Close the session
	 */
	public void closeSessionForReal () {
		try {
			getSession().close();
		}catch(Exception ex){}
	}

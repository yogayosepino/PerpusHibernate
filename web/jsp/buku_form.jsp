...
function valid(){
	if(document.forms[0].namaBuku.value==""){
	...
	if(document.forms[0].namaKategori.value=="") {
		alert('Kategori is required');
		return false;
	}
}
 function doBack()
 {			
    	document.forms[0].action = "<html:rewrite page="/buku/list.do" />";

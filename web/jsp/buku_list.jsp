...
<%@page imporst="com.ams.model.dao.BukuDAO"%>
...
<script language="javascript" type="text/javascript" src="<html:rewrite page="/js/Ajax.js"/>"></script><!--buat AJAX-->
    ...
    <h3><html:errors/></h3>
        ...
        <center>                    
             <table width="50%" border="3" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="left">Kategori Buku</td>
					<td align="left">: &nbsp;</td>
	...
	<!--  	<tr>
				...
				<logic:present name="bukuList" scope="request">
				  ...
				  <tr>
				  	<td align="center"><%=i%></td>
						<td align="center"><bean:write name="buku" property="kodeBuku" scope="page"/></td>						
						...
						<td align="center"><html:link action="/buku/detail" paramId="id" paramName="buku" paramProperty="id">detail</html:link></td>					
						<td align="center"><html:link action="/buku/form" paramId="id" paramName="buku" paramProperty="id">edit</html:link></td>
						<td align="center"><html:link action="/buku/delete" paramId="id" paramName="buku" paramProperty="id">delete</html:link></td>
					</tr>
					<% i++; %>
					</logic:iterate>
			    </logic:present> 
		...
		<center>
			...
			<input class = "button" type="button"  onclick="doAdd()" value=<bean:message key ="page.tambahBuku.title" />">
		</center>
		<tr>
			<td>
				<center>

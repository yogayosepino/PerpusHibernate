...
<html:form action = "/anggota/popup">
				...
				<logic:present name="anggotaList" scope="request">
				  ...
				  <tr>
				  	<td align="center"><%=i%></td>
						<td align="center"><a href="#" onclick="javascript:popup('<bean:write name="anggota" property="nama" scope="page"/>','<bean:write name="anggota" property="id" scope="page"/>');" /><bean:write name="anggota" property="kode" scope="page"/></td>						
...
function gotoPager() {
    ...
    function popup(x,y) {
    	top.window.opener.focus();
    	  top.window.opener.document.forms[0].namaAnggota.value=x;
    	  top.window.opener.document.forms[0].idAnggota.value=y;
